                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="relative ml-1">
                        ...
                        {showPreview && items.length > 0 && pathname !== '/cart' && (
                            <div
                                className="absolute top-full right-0 mt-3 w-80 bg-white border border-gray-100 rounded-2xl shadow-xl z-[100] overflow-hidden animate-in fade-in slide-in-from-top-4 duration-300"
                                onMouseEnter={handleMouseEnter}
                                onMouseLeave={handleMouseLeave}
                            >
