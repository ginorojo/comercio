                        ...
                        <div className="lg:col-span-8">
                            <div className="bg-white border border-gray-100 rounded-3xl overflow-hidden shadow-sm">
                                <ul role="list" className="divide-y divide-gray-100">
                                    {items.map((item) => (
                                        <li key={item.id} className="flex p-6 sm:p-8 hover:bg-gray-50/50 transition-colors">
                                            <div className="flex-shrink-0 w-32 h-32 sm:w-40 sm:h-40 border border-gray-100 rounded-2xl overflow-hidden bg-gray-50 relative">
                                                <Image
                                                    src={item.image}
                                                    alt={item.title}
                                                    fill
                                            ...
                                            <div className="ml-6 flex-1 flex flex-col justify-between">
                                                <div className="flex justify-between sm:grid sm:grid-cols-2 lg:grid-cols-2 gap-x-6">
                                                    <div className="pr-6">
